...
FD  L-PRINT
    LABEL RECORDS ARE STANDARD
    VALUE OF IDENTIFICATION IS "REPORTSTA".
...
01  HEAD-OUT-1.
        ...
        02 FILLER               PIC X(36).
        02 FILLER               PIC X(14); VALUE " STATUS REPORT".
...
START.
   ...
   SORT TEMPFIL ON ASCENDING KEY NO1,NO2 USING K-IN GIVING IN-FILE.

RPT.
        DISPLAY " ".DISPLAY " ".
        DISPLAY "GENERATING REPORT.STA ..." WITH NO ADVANCING.
    ...
    MOVE DASHES TO DASH-1,DASH-2,DASH-3,DASH-4.
        MOVE "TOTAL FOR STATUS: " TO TOT-LINE.

READ-IN.
        MOVE STAT TO LAS-STAT.
...
PAGER.
        ...
        WRITE PRINT-OUT BEFORE ADVANCING 3 LINES.
        ADD 1 TO PAGE-COUNT; MOVE PAGE-COUNT TO HEADER-PAGE.
        MOVE "+PIT REPORT+" TO NUM-FIRST.
        MOVE "PAGE" TO NUM-HEAD.
