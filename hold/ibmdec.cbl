...
PROGRAM-ID.  IBMDEC    VERSION 1-1.
AUTHOR. TYMSHARE.
DATE-WRITTEN. JAN 1973.
REMARKS.  DERIVED FROM D.E.C. COBRCA.CBL PROGRAM
...
01	MISCELLANEOUS-STUFF.
	...
	02 LAST-CHARACTER	PICTURE X.
        ...
        02 SYNC-FOUND-FLAG      PICTURE X.
          88 SYNC-FOUND  VALUE "X".
...
01	TO-HOLD-A-WORD		PICTURE X(70).
        ...
        88 QUITING              VALUE "Q","QU","QUI","QUIT",
                                      "STOP","EXIT","E","EN","END".
        88 NEEDS-HELP           VALUE "?","H","HE","HEL","HELP".
	...
	88 W-OMITTED		VALUE "OMITTED".
        88 W-SYNC               VALUE "SYNC","SYNCHRONIZED".
        88 W-THEN               VALUE "THEN".
        88 W-DISPLAY-ST         VALUE "DISPLAY-ST".
        88 W-TIME-OF-DAY        VALUE "TIME-OF-DAY".
        88 W-OTHERWISE          VALUE "OTHERWISE".
        88 W-EXHIBIT            VALUE "EXHIBIT".
        88 W-NAMED-CHANGED      VALUE "NAMED","CHANGED".
	88 W-INCLUDE		VALUE "INCLUDE".
	88 W-COMPUTATIONAL-X	VALUE "COMPUTATIONAL-3", "COMP-3",
                                      "COMPUTATIONAL-4","COMP-4",
                                      "COMPUTATIONAL-2","COMP-2".
	88 W-ID			VALUE "ID","IDENTIFICATION".
	88 FLAG-CLAUSE		VALUE "TODAYS-DATE", "BLOCK", "CONTAINS",
                                      "LINKAGE","COMMUNICATION",
                                      "TOTALED","TOTALING","SIGN",
                                      "CHARACTERS", "COPY","CLASS",
                        "CLASS","SIZE","SIGNED","POINT","LEADING".
	88 W-DELETE-CLAUSE	VALUE "RECORDING".
	88 W-ZERO		VALUE "0", "ZERO".
	88 W-NOTE		VALUE "NOTE".
	88 W-ADVANCING		VALUE "ADVANCING".
        88 ENV-WORDS-FLAGGED    VALUE "RERUN","REEL","MULTIPLE",
                                      "APPLY","FIXED","COUNT","SYMBOL",
                                      "COMPATIBLE","PRINT",
                                      "POSITION".
	88 PD-WORDS-FLAGGED-3	VALUE "ENTER", "TRANSFORM", "CALL",
                                     "REWRITE", "DELETE","CHANNEL",
                        "SWITCH","USER-NUMBER","DISP","GOBACK",
                                "END-OF-PAGE","EOP","EXIT",
                        "COPY","POSITIONING".
	88 W-TODAYS-DATE	VALUE "TODAYS-DATE","CURRENT-DATE".
        88   PD-WORDS-FLAGGED-2 VALUE "RETURN-CODE","SORT-FILE-SIZE",
                                "SORT-CORE-SIZE","SORT-MODE-SIZE",
                                "SORT-RETURN","LABEL-RETURN","UPON",
                                "ENTRY","START","BASIS","INSERT",
                                "DELETE","READY","RESET","TRACE","DEBUG",
                                "EJECT","SKIP1","SKIP2","SKIP3",
                                "STRING","UNSTRING","DATE","DAY",
                                "TIME","USING".
	88 W-CHARACTERS		VALUE "CHARACTERS".
	88 W-F-U-V		VALUE "F", "U", "V".
	88 W-CONSOLE		VALUE "CONSOLE","SYSIN","SYSOUT","SYSPUNCH".
...
01      NEW-IDENT-CLAUSE.
        02 FILLER               PICTURE X(36)
          VALUE "         VALUE OF IDENTIFICATION IS ".
        02 IDENT-CLAUSE-ID      PICTURE X(15)
          VALUE SPACES.
...
START.    DISPLAY "IBM TO DEC  COBOL PROGRAM CONVERSION AID".
...
FETCH-COMMAND.
        ...
        IF INSTRUCTIONS
          ...
          DISPLAY"      THE NAME OF THE FILE WILL BE THE SAME",
          DISPLAY "     AS THE INPUT FILE BUT WITH THE  .CBL EXTENSION.",
          DISPLAY "     2)  A LISTING FILE SHOWING THE SOURCE FILE",
          DISPLAY "     WITH FLAGS OF POSSIBLE PROBLEM AREAS.",
          DISPLAY "     THE NAME OF THIS FILE IS THE SAVE AS",
...
RESTART-1. DISPLAY "IBM-FORMAT FILE NAME: " WITH NO ADVANCING.
	...
	IF PROGRAM-NAME = "EXIT" OR PROGRAM-NAME = "QUIT"   STOP RUN.

        MOVE PROGRAM-NAME TO SOURCE-ID.
        
 RESTART-2.
        DISPLAY "DEC-FORMAT OUTPUT FILE NAME: " WITH NO ADVANCING.
        ACCEPT TEMPORARY-NAME.
        MOVE 0 TO I; MOVE SPACES TO PROGRAM-NAME.
        PERFORM CONVERT-ID VARYING J FROM 1 BY 1 UNTIL J > 10.
...
PROCESS-ID-1.
	IF W-REMARKS MOVE "X" TO REMARKS-FLAG.
        IF W-PROGRAM-ID MOVE "*2*" TO LISTING-FLAG.
        IF W-ENVIRONMENT
          DISPLAY "---ENVIR.",
          MOVE SPACES TO REMARKS-FLAG,
...
PROCESS-ENV-1.
	...
	IF W-ASSIGN GO TO PROCESS-ASSIG
PROCESS-ENV-2.
...
*	ASSIGN TO DSK: REPLACES ALL OTHER ASSIGNS.


PROCESS-ASSIGN.
	PERFORM PUT-WORD.
	MOVE "DSK," TO THIS-WORD.
	PERFORM PUT-WORD.
        MOVE "*1*" TO LISTING-FLAG.
	PERFORM WRITE-LINE.
        MOVE "      RECORDING MODE IS ASCII." TO SHORTEST-LINE.
...
*	OBJECT-COMPUTER. REPLACE PARAGRAPH WITH <PDP-10.>
...
PROCESS-DD-0.
	...
	IF W-DELETE-CLAUSE GO TO DELETE-CLAUSE.
        ...
        IF W-DISPLAY-ST GO TO PROCESS-DISPLAY-ST.
        IF W-SYNC  GO TO PROCESS-SYNC.
	IF W-COMPUTATIONAL-X GO TO PROCESS-COMP-X.
	IF W-OMITTED GO TO PROCESS-LABEL-OMITTED.
	IF W-FD GO TO PROCESS-FD.
        IF W-ID GO TO PROCESS-ID.
...
*	COMPUTATIONAL-2,3,4.  CHANGE TO COMPUTATIONAL AND FLAG.
...
PROCESS-FD.
	...
	PERFORM PUT-WORD.
        MOVE "*2*" TO LISTING-FLAG.
	PERFORM WRITE-LINE.
        MOVE SPACES TO IDENT-CLAUSE-ID.
        DISPLAY "VALUE OF IDENTIFICATION IS (ENTER QUOTED STRING)"
            WITH NO ADVANCING.
        ACCEPT IDENT-CLAUSE-ID.
        IF IDENT-CLAUSE-ID EQUALS SPACES
            MOVE VALUE-OF-ID-CLAUSE TO SHORTEST-LINE,
            MOVE "*3*" TO LISTING-FLAG;
        ELSE MOVE NEW-IDENT-CLAUSE TO NEXT-SHORTEST-LINE,
             MOVE "*1*" TO LISTING-FLAG.
	PERFORM WRITE-LINE.
	GO TO PROCESS-DD-0.

*	LABEL VALUE OMITTED.  SUBSTITUTE STANDARD.

PROCESS-LABEL-OMITTED.
	MOVE "STANDARD" TO THIS-WORD.
        MOVE "*1*" TO LISTING-FLAG.
	PERFORM PUT-WORD.
	GO TO PROCESS-DD-0.
...
PROCESS-SYNC.
        IF NOT SYNC-FOUND 
          DISPLAY "WARNING: SYNC CLAUSE NOT ALLOWED AT GROUP LEVELS".
        MOVE "X" TO SYNC-FOUND-FLAG.
        MOVE "*2*" TO LISTING-FLAG.
        PERFORM PUT-WORD.
        GO TO PROCESS-DD-0.
...
PROCESS-PD-B.
        ...
        IF W-TIME-OF-DAY  GO TO PROCESS-TIME-OF-DAY.
        IF W-THEN  MOVE "*1*" TO LISTING-FLAG,
                   GO TO PROCESS-PD-0.
        IF W-EXHIBIT  GO TO PROCESS-EXHIBIT.
        IF W-OTHERWISE  GO TO PROCESS-OTHERWISE.
	IF W-INCLUDE GO TO PROCESS-INCLUDE.
	IF W-TODAYS-DATE GO TO PROCESS-TODAYS-DATE-PD.
	IF W-ADVANCING GO TO PROCESS-ADVANCING.
	IF W-CONSOLE GO TO PROCESS-CONSOLE.
        IF FLAG-COLLATE
...
PROCESS-PD-1.
	IF PD-WORDS-FLAGGED-2 MOVE "*2*" TO LISTING-FLAG.
...
*	ADVANCING.  IF 0 LINES, SUBSTITUTE TOP-OF-PAGE.
...
PROCESS-ADVANCING.
	...
	PERFORM GET-WORD.
	IF W-LINES MOVE "TOP-OF-PAGE" TO THIS-WORD,
            MOVE "*1*" TO LISTING-FLAG.
	PERFORM PUT-WORD.
	GO TO PROCESS-PD-0.

*	TODAYS-DATE.  SUBSTITUTE TODAY AND FLAG.

PROCESS-TODAYS-DATE-PD.
	MOVE "TODAY<D>" TO THIS-WORD.
	PERFORM PUT-WORD.
	MOVE "*3*" TO LISTING-FLAG.
	GO TO PROCESS-PD-0.

PROCESS-CONSOLE.
	MOVE "TTY" TO THIS-WORD, MOVE "*1*" TO LISTING-FLAG.
	PERFORM PUT-WORD.
	GO TO PROCESS-PD-0.
...
PROCESS-EXHIBIT.
        ...
        PERFORM PUT-WORD.
        PERFORM GET-WORD.
        IF W-NAMED-CHANGED PERFORM GET-WORD.
        IF W-NAMED-CHANGED PERFORM GET-WORD.
        GO TO PROCESS-PD-B.
...
GW-1.
	...
	MOVE SPACES TO THIS-WORD; MOVE 0 TO I.
        IF THIS-CHARACTER EQUALS QUOTE
            IF J = 1 SUBTRACT 6 FROM FIRST-COLUMN GIVING J;
                GO TO GW-7;
            ELSE GO TO GW-7.
...
*       TEST FOR COMMENT LINE
        ...
        IF THIS-CHARACTER NOT EQUAL TO "*" GO TO CONVERSION.
        IF J NOT EQUAL  1  OR END-OF-LINE PERFORM PUT-WORD,
                                          PERFORM WRITE-LINE.
...
GWC-0.
	PERFORM GET-CHARACTER THRU GC-EXIT.
	IF CCOLUMN NOT EQUAL TO 7 AND THIS-CHARACTER NOT EQUAL TO SPACE
		GO TO GWC-EXIT.

GWC-1. IF CCOLUMN EQUALS 7 GO TO GWC-3.
GWC-2.
	PERFORM GET-CHARACTER THRU GC-EXIT.
...
GWC-4.
	PERFORM GET-CHARACTER THRU GC-EXIT.
	IF CCOLUMN EQUALS 7 GO TO GWC-3.
