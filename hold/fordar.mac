UNIVERSAL FORDAR %2.(146)	LIB40=V32(413)	15-NOV-72
	SUBTTL	TOM EGGERS/DMN/DRT		30-MAR-1973
...
>
IFE CPU-KI10,<
	JUMPG	X,.+3		;JUMP POSITIVE
	JUMPE	X+1,SNG2	;EXIT IF ZERO
	SUBI	X+1,1		;SPECIAL CASE FOR NUM=1B1
	TLNN	X+1,(1B1)	;ROUNDING NEEDED
	JRST	SNG2		;NO, RETURN
	CAME	X,[377777,,-1]	;YES, WILL NUMBER OVERFLOW
	AOSA	X		;NO, ROUND THE HIGH ORDER WORD
	FSC	X,1		;YES, FORCE A FLOATING OVERFLOW MESSAGE
	JUMPL	X,SNG2		;IS THE NUMBER POSITIVE
	TLO	X,400		;YES, FORCE MOST SIGNIFICANT FRACTION BIT ON
>
SNG2:	GOODBY			;EXIT
>
...
TITLE DFD.12
SUBTTL  DOUBLE PRECISION ADD AND SUBTRACT- TOM EGGERS/DMN/DRT
;***COPYRIGHT 1972,1973 DIGITUIPMENT CORP., MAYNARD, MASS.***
SEARCH FORDAR,FORPRM
DFD 12
PRGEND
