...
460 DATA DEPARTMENT,	1,1,0,13,0,9
470 DATA CHECK,		0,1,0, 4,1,5
480 DATA DESCRIPTION,	0,0,0, 9,2,32
500 DATA CUSTOMER,	1,1,0,13,0,9
510 DATA AMOUNT,	0,1,1, 6,4,10
515 '
...
2310     O(X)=F(X,Y)
2320   NEXT X
2322   O(15)=INT(O(11)/100)		'  SPLIT LIST CONTROL NO.'S
2324   O(11)=INT(O(11)-100*O(15))	'  INTO TWO PARTS
2326   O(16)=INT(O(12)/100)
2328   O(12)=INT(O(12)-100*O(16))
2330   GOSUB 6000
2340   CHANGE O TO S1$
2350   S2$ = S1$ + N$(Y)
...
4510 PRINT Q$;
4515 INPUT I$
4520   IF I$<>"Y" GO TO 4530
4525     I$="YES"
4530   IF I$<>"N" GO TO 4540
4535     I$="NO"
4540   IF I$="YES" GO TO 4560
4545   IF I$="NO" GO TO 4560
4550 PRINT "PLEASE ANSWER 'YES' OR 'NO'"
4555   GO TO 4500
4560 RETURN
4600 REM -------- STR$ ------------
