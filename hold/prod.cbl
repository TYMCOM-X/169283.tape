...
FD  L-PRINT
    LABEL RECORDS ARE STANDARD
    VALUE OF IDENTIFICATION IS "REPORTPRD".
...
01  HEAD-OUT-1.
        ...
        02 FILLER               PIC X(36).
        02 FILLER               PIC X(19); VALUE "PRODUCT REPORT".
...
START.
   ...
   SORT TEMPFIL ON ASCENDING KEY NO2,NO1 USING K-IN GIVING IN-FILE.

RPT.
        DISPLAY " ". DISPLAY " ".
        DISPLAY "GENERATING REPORT.PRD ..." WITH NO ADVANCING.
...
FINISH.
    ...
    CLOSE L-PRINT.
        ...
        DISPLAY "FINISHED.".
        MOVE 1 TO ARGUM.
        ENTER MACRO LINKER USING ARGUM.
    STOP RUN.
    