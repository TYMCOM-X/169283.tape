TITLE DABS  %2.(145);FROM LIB40	24-AUG-71	/KK/DMN
SUBTTL	D. TODD /DRT	29-MAR-1973
...
;DOUBLE PRECISION ANSWER IS RETURNED IN ACCUMULATORS A AND B.
	...
	HELLO	(DABS,.)			;ENTRY TO DABS ROUTINE
	...
	PRGEND
TITLE DMOD  %2.(120);FROM LIB40	27-AUG-71	/KK/DMN/TWE
...

	HELLO	(DMOD,.)			;ENTRY TO DMOD ROUTINE.
...
SAV2:	BLOCK 1
	...
	PRGEND
TITLE	DMAX1  %2.(120);FROM LIB40	24-AUG-1971	/TWE
SUBTTL	D. TODD /DRT	15-FEB-1973
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS.***
...
;ACCUMULATOR A AND B.
	...
	HELLO	(DMAX1,.)			;ENTRY TO DMAX1 ROUTINE
	PUSH	P,C		;SAVE AC C
IFN F40LIB,<
...
DMAX.2:	MOVEI	C,@1(Q)		;GET ADDRESS OF NEXT ARGUMENT
	AOBJN	L,DMAX.1	;END OF ARG LIST
IFN F40LIB,<
	TLNN	L,-1		;F40 CALL
...
>
	...
	GOODBY	(2)
	PRGEND
TITLE	DMIN1  %2.(163);FROM LIB40	24-AUG-1971	/TWE
SUBTTL	D. TODD /DRT	24-MAY-1973
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS.***
...
;IN ACCUMULATOR A AND B
	...
	HELLO	(DMIN1,.)			;ENTRY TO DMIN1 ROUTINE
	PUSH	P,C		;SAVE AC C
IFN F40LIB,<
...
DMIN.2:	MOVEI	C,@1(Q)		;GET ADDRESS OF NEXT ARG
	AOBJN	L,DMIN.1	;CONTINUE THRU THE LIST
IFN F40LIB,<
	TLNN	L,-1		;F40 CALL
...
>
	...
	GOODBY	(2)
	PRGEND
TITLE DSIGN	%2.(120);FROM LIB40	24-AUG-71	/KK/DMN
SUBTTL	D. TODD /DRT	15-FEB-1973
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS.***
...
;ANSWER IS RETURNED IN ACCUMULATORS A AND B.
	...
	HELLO	(DSIGN,.)			;ENTRY TO DSIGN ROUTINE
	DMOVE	A,@(Q)		;GET FIRST ARGUMENT
	SKIPGE	@1(Q)		;THEN
	JUMPL	A,OUT		;CHOOSE
	SKIPL	@1(Q)		;THE
...
OUT:	GOODBY	(2)		;EXIT
	PRGEND
TITLE	DEXP.2	%2.(120) 	PDP-10/10I DOUBLE PRECISION EXP2 FUNCTION
SUBTTL	D. TODD /DRT	15-FEB-1973
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS.***
...
PRGEND
TITLE	DEXP.3	%2.(120) 	PDP-10/10I DOUBLE PRECISION EXP.3 FUNCTION
SUBTTL	D. TODD /DRT	15-FEB-1973
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS.***
...
PRGEND
TITLE DEXP	%2,(120)        PDP-10/10I DOUBLE PRECISION EXPONENTIAL FUNCTION
SUBTTL	D. TODD /DRT	15-FEB-1973
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS.***
...
B4:	DOUBLE 207535527021,2172221	;B4 = 87.41749 72022 35527 474
...
FB4F:	BLOCK	2	;TEMP FOR F+B4*F
	...
	PRGEND
TITLE DLOG	%2.(120)       PDP-10/10I DOUBLE PRECISION LOGARITHM FUNCTION
SUBTTL	D. TODD /DRT	15-FEB-1973
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS.***
...
;THE DOUBLE PRECISION ANSWER IS RETURNED IN AC A AND B.
	...
	HELLO	(DLG10.,DLOG10)			;ENTRY TO DLOG10 ROUTINE
...

	...
	HELLO	(DLOG,.)			;ENTRY TO DLOG ROUTINE
...
ACSAVE:	BLOCK	X-C+1
	...
	PRGEND
TITLE DSQRT  %2.(120);FROM LIB40	23-NOV-71	/KK/TWE/DMN
SUBTTL	D. TODD /DRT	15-FEB-1973
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS.***
...
SEARCH FORPRM
	...
	ERROR	(LIB,13,2,[ASCIZ /Attemp to take DSQRT of Negative Arg/])
...
N:	BLOCK 2		;STORAGE FOR ARGUMENT
	...
	PRGEND
TITLE DSIN  %2.(120);FROM LIB40	 24-AUG-1971	/KK/TWE
SUBTTL	D. TODD /DRT	15-FEB-1973
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS.***
...
	HELLO	(DCOS,.)			;ENTRY TO COSINE ROUTINE
	...
	HELLO	(DSIN,.)			;ENTRY TO SINE ROUTINE
	MOVE	0,XBLT
	BLT	0,ACSAVE+X-C	;SAVE ACCUMULATORS
	DMOVE	A,@(Q)		;GET DOUBLE WORD ARGUMENT
...
LIT
	PRGEND
TITLE DATAN2 %2.(156);FROM LIB40	27-AUG-71	/KK/DMN/TWE
SUBTTL	D. TODD /DRT	15-FEB-1973
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS.***
...
	HELLO	(DATN2.,DATAN2)			;ENTRY TO DATAN2 ROUTINE
...
PI.:	DOUBLE 202622077325,021026430215	;DEC=3.14159265358979323846
	...
	PRGEND
TITLE DATAN  %2.(120);FROM LIB40	31-MAY-72	/TWE/DMN
SUBTTL	D. TODD /DRT	15-FEB-1973
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS.***
...
	SIXBIT /DATAN/
	HELLO	(DATAN,.)			;ENTRY TO DATAN ROUTINE
	MOVE	0,XBLT		;SAVE ACCUMULATORS
	BLT	0,ACSAVE+X-C	;...
...
DATAN3:
IFE CPU-KA10,<TRNN	G,1		;ADD ATAN(1/2)?
	JRST	DATAN4		;NO
FLADD A,ATANH
...
X2:	BLOCK 2		;HOLDS X**2
	...
	PRGEND

TITLE	DFLOAT  %2.(120);FROM LIB40	19-APR-72	ED YOURDON/KK/VAA/TWE/DMN
SUBTTL	D. TODD /DRT	15-FEB-1973
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS.***
...
;THE ANSWER IS RETURNED IN ACCUMULATORS A AND B
	...
	HELLO	(DFLOT.,DFLOAT)			;ENTRY TO FLOAT DROUTINE
	MOVE	T0,@(L)		;PICK UP THE ARGUMENT
	PJRST	DFL.0##		;USE DFL.0 ROUTINE
	PRGEND
TITLE IDINT	%2.(120);FROM LIB40	25-AUG-1971	TOM EGGERS/DMN
SUBTTL	D. TODD /DRT	15-FEB-1973
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS.***
...
Q=16
	...
	HELLO	(IDFIX,.)		;ENTRY TO IDFIX
	JRST	DFIX1		;GO TO MAIN LINE
	HELLO	(DFIX,.)		;ENTRY TO DFIX
	JRST	DFIX1
	HELLO	(IDINT,.)
DFIX1:
	...
	PRGEND
TITLE	DBLE  %2.(120);FROM LIB40	29-DECEMBER-1969		ED YOURDON/KK
SUBTTL	D. TODD /DRT	15-FEB-1973
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS.***
...
;LEFT IN ACCUMULATOR A, AND THE LOW ORDER PORTION IN B.
	...
	HELLO	(DBLE,.)			;ENTRY TO DOUBLE ROUTINE
	MOVE	A, @(Q)		;GET THE ARGUMENT IN HIGH ORDER
	MOVEI	B, 0		;SET LOW ORDER PORTION TO ZERO
	GOODBY	(1)		;EXIT

	PRGEND
TITLE	SNGL	%2.(120);FROM LIB40	20-SEPT-71	/DMN/TWE
SUBTTL	D. TODD /DRT	15-FEB-1973
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS.***
...
;ANSWER IS RETURNED IN ACCUMULATOR A.
	...
	SEARCH FORPRM
	HELLO	(SNGL,.)			;ENTRY TO SNGL ROUTINE
