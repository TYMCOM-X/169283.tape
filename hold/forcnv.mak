TITLE ALPHA% %2.(131) 	ALPHANUMBERIC INPUT/OUTPUT ROUTINES
	SUBTTL	D. TODD /DRT/     23-FEB-1973
...
ALPHO2:	JSP	P1,OBYTE.	;OUTPUT THE CHARACTER
	...
	PRGEND
TITLE FLIRT%	%2(100)	FLOATING POINT INPUT
	SUBTTL	D. TODD /DRT/     08-DEC-1972	D.M.NIXON
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS.***
...
IFE CPU-KA10,<
	...
	PRGEND
TITLE FLOUT%	%2(100)  	FLOATING POINT OUTPUT	FORTRAN IV
	SUBTTL	D. TODD /DRT/     08-DEC-1972	D.M.NIXON/DRT
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS.***
...
FLOT4A:	PUSHJ	P,DPMUL		;SCALEOWER OF 10
...
PRGEND
TITLE INTEG%  %2.(100)  DECIMAL INTEGER INPUT/OUTPUT FORTRAN IV
...
INTO6:	POPJ	P,		;RETURN TO FOROTS
	PRGEND
TITLE	LOGIC% %2.(100) LOGICAL INPUT/OUTPUT CONVERSION ROUTINES
	SUBTTL	D. TODD /DRT/     08-DEC-1972
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS.***
...
LOUT3:	POPJ	P,		;RETURN TO FOROTS
	PRGEND
TITLE OCTAL% %2.(131) OCTAL INPUT/OUTPUT CONVERSION ROUTINE
	SUBTTL	D. TODD /DRT/     23-FEB-1973
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS.***
...
OCTO3:	POPJ	P,		;YES, RETURN TO FOROTS
	PRGEND
TITLE	POWTB%	%2.(100)	D.P. INTEGER POWER OF TEN TABLE
...
>	;END OF REPEAT 0
	...
	PRGEND
	TITLE LSTDR% %2.(112) LIST DIRECT I/O MODULE
...
LSTDR2:	PUSHJ	P,(T1)		;OUTPUT THE VARIABLE
	...
	PRGEND
TITLE	NMLST%	%2.(151)	NAMELIST I/O
...
NLIF:	PUSHJ	P,NLISCN	;FIND SOME DATA
	...
	JSP	P1,NLIDLM	;CHECK THE DELIMITER
	JUMPSP	NLID1		;JUMP ON SINGLE PRECISION
