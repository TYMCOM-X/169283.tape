...
FD  L-PRINT
    LABEL RECORDS ARE STANDARD
    VALUE OF IDENTIFICATION IS "REPORTDST".
...
01  LEVEL-0-ACS; COMPUTATIONAL.
    02 ACCUMULATOR-1    PIC S9(6)V9(3).
    02 ACCUMULATOR-2            PIC S9(10)V99.
    02 ACCUMULATOR-3            PIC S9(10)V99.
    02 ACCUMULATOR-4            PIC S9(10)V99.
...
01  HEAD-OUT-1.
        ...
        02 FILLER               PIC X(29).
        02 FILLER               PIC X(26);
            VALUE " STATUS REPORT BY DISTRICT".
...
START.
   ...
   SORT TEMPFIL ON ASCENDING KEY NOX,NO1,NO2 USING K-IN GIVING IN-FILE.

RPT.
        DISPLAY " ". DISPLAY " ".
        DISPLAY "GENERATING REPORT.DST ..." WITH NO ADVANCING.
