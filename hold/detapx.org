...
011010     RECORDING MODE IS F                                          03  IORT
011020     RECORD CONTAINS 133 CHARACTERS                               03  IORT
011030     BLOCK  CONTAINS   0 RECORDS                                  03  IORT
011040     LABEL RECORDS ARE OMITTED                                    03  IORT
011050     DATA RECORDS ARE LISTOUTPUT                                  03  IORT
011060                      FORMAT-LISTING-RECORD.                      03  IORT
...
012010     RECORDING MODE IS F                                          03  IORT
012020     RECORD CONTAINS 80 CHARACTERS                                03  IORT
012030     BLOCK  CONTAINS  0 RECORDS                                   03  IORT
012040     LABEL  RECORDS ARE OMITTED                                   03  IORT
...
013010     RECORDING MODE IS F                                          03  IORT
013020     RECORD CONTAINS 660 CHARACTERS                               03  IORT
013030     BLOCK  CONTAINS   0 RECORDS                                  03  IORT
013040     LABEL RECORDS ARE OMITTED                                    03  IORT
013050     DATA RECORD IS FORMAT-WORK-RECORD.                           03  IORT
...
020720            :            PROPERTY OF IMI + XXXXXXXXXXXXXXXXXXXX:. 00  INPT
020750 77  CHARACTER-HOR-DITTO         PICTURE X                        00  INPT
020760                         VALUE : :.                               00  INPT
...
0277  WRITE-PUNCH                 PICTURE X                        00  INPT
...
050005 77  LINECT                      PICTURE S9[3]   COMPUTATIONAL-3  04  FRMT
...
050100 77  INIT-BOX-IND                PICTURE S9[3]   COMPUTATIONAL-3  04  FRMT
...
070550     03  TNARRAY                 PIC S9  COMP-3 OCCURS 50.        00  INPT
070560                                                                  00  INPT
...
071760 01  TEMP-GEN-SWITCHES   REDEFINES TEMP-VECTOR.                   00  INPT
...
072450             07  ININDEX         PICTURE S9[3]   COMPUTATIONAL.   00  INPT
072455             07  IN-ITIAL        PIC X[62]                        00  INPT
072460                         OCCURS 45.                               00  INPT
072465             07  FILLER          PICTURE X[8].                    00  INPT
...
072690     03  COUNT-IN-SPILL          PICTURE S9[3]   COMPUTATIONAL-3. 00  INPT
072700     03  SPILL-INDEX             PICTURE S9[3]   COMPUTATIONAL-3. 00  INPT
072710     03  FILLER                  PICTURE X[820].                  00  INPT
...
072940                         OCCURS 60.                               00  INPT
072950     03  FILLER                  PICTURE X[300].                  00  INPT
072960                                                                  00  INPT
072970                                                                  00  INPT
...
076030     03  INCREMENT               PICTURE S9      COMPUTATIONAL-3  00  INPT
...
100460     03  FILLER                  PICTURE S9[4]   COMPUTATIONAL    01  DCMP
100470                         OCCURS 50.                               01  DCMP
100480                                                                  01  DCMP
...
201230     MOVE :/*: TO BUFFER.             NOTE 360 DEPENDENT.         00 *INPT
201240     PERFORM I10-WRITE-OUTPUT THRU I45-WRITE-OUTPUT-EXIT.         00  INPT
201250                                                                  00  INPT
...
202330     IF TALLY NOT EQUAL TO ZERO                                   00  INPT
...
202420     ADD 1 TO TALLY.     NOTE ONLY HERE ON 1ST NON-BLANK-RL CARD. 00  INPT
202430     MOVE TALLY TO REXTENSIONS [1]. NOTE 1ST SIGNIF RULE COLUMN.  00  INPT
202440     ADD 1 TO TALLY.                                              00  INPT
202450     MOVE 001 TO CNTR-1.                                          00  INPT
202460                                                                  00  INPT
202470 A56-MOVE-RULES-TO-STRING.                                        00  INPT
202480     MOVE CRDCOL [TALLY] TO STR-ING [CNTR-1].                     00  INPT
202490     ADD 001 TO CNTR-1.                                           00  INPT
202500     ADD 1 TO TALLY.                                              00  INPT
202510     IF TALLY LESS THAN 64                                        00  INPT
...
202560     IF TALLY EQUAL TO ZERO                                       00  INPT
...
202760     ADD 1 TO TALLY.                                              00  INPT
202770     MOVE TALLY TO REXTENSIONS [EXTINDEX].                        00  INPT
202780     ADD 1 TO TALLY.                                              00  INPT
...
203740     PERFORM C00-EDIT-AND-CONVERT-TO-LE THRU                      00  INPT
203750             E50-EDIT-CONVERT-EXIT.                               00  INPT
...
208070     IF TALLY GREATER THAN 59                                     00  INPT
...
209500     EXAMINE STUBIES [LEFT-1] TALLYING UNTIL FIRST : :.           00  INPT
209510                        NOTE COLON IN QUOTES-CHANGE FOR HN CHAIN. 00  INPT
209520     IF TALLY EQUAL TO 60                                         00  INPT
209530         GO TO C09-COLON-OP-SEARCH-LOOP.                          00  INPT
209540     MOVE TALLY TO LEFT-2.                                        00  INPT
209550                                                                  00  INPT
...
215528     SUBTRACT TALLY FROM SUBX GIVING TALLY.                       00  INPT
215530     IF TALLY GREATER THAN 003                                    00  INPT
...
229490     ENTER LINKAGE.                                               00  INPT
229500     CALL :DETAPCD: USING QX.                                     00  INPT
229510     ENTER COBOL.                                                 00  INPT
229515                   NOTE CALL FOR OS ONLY-SETS RETURN CODE         00  INPT
229516                      AND RETURNS CONTROL TO SUPERVISOR.          00  INPT
...
600620     WRITE LISTOUTPUT AFTER POSITIONING CONTROLX LINES.           03  IORT
600630* THE ABOVE STMT IS NOT STD COBOL - S/B CHANGED ALONG WITH        03  IORT
600631*    LINES  600580  AND 600940 WHEN TIME ALLOWS                   03  IORT
...
600780     MOVE INPUTREC TO WS-CARD.                                    03  9ORT
...
601130     MOVE BUFFER TO PUNCHOUT.                                     03  IORT
...
703360     IF TALLY GREATER THAN 69                                     04  FRMT
...
705570     EXAMINE PR-LINE REPLACING ALL :?: BY : :.                    04  FRMT
