TITLE	MAX	%2.(120) ;FROM LIB40 VERSION V.32(415)
SUBTTL	D. TODD /DRT 15-FEB-1973	ED YOURDON/TWE/DMN/KK
...
TITLE	MIN	%2.(160) ;FROM LIB40 VERSION V.32(415)
SUBTTL	D. TODD /DRT 02-MAY-1973	ED YOURDON/TWE/KK/DMN
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS. ***
...
TITLE	ACOS	%2.(120) ;FROM LIB40 VERSION V.027
SUBTTL	D. TODD /DRT 15-FEB-1973	KAREN KOLLING/DMN
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS. ***
...
TEMPSV:	0
	PRGEND
TITLE	ASIN  %2.(120) ;FROM LIB40 VERSION V.027 
SUBTTL	D. TODD /DRT 15-FEB-1973	ED YOURDON/KK/DMN
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS. ***
...
ONE:	1.0
	PRGEND
TITLE	ATAN2 %2.(120) ;FROM LIB40 VERSION V.32(302)
SUBTTL	D. TODD /DRT 15-FEB-1973	/TWE/KK/DMN
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS. ***
...
;THE ANSWER IS RETURNED IN ACCUMULATOR A.
	...
	HELLO	(ATAN2,.)		;ENTRY POINT TO ATAN2 ROUTINE
...
TEMP:	0
	PRGEND
TITLE	ATAN  %2.(120) ;FROM LIB40 VERSION V.022
...
	HELLO	(ATAN,.)		;ENTRY TO ARCTANGENT ROUTINE
...
PIOT:	201622077325		;PI/2
	PRGEND
TITLE	SQRT	%2.(120) ;FROM LIB40 VERSION V.30.0.142
SUBTTL	D. TODD /DRT 15-FEB-1973	TONY LAUCK/TWE/DMN
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS. ***
...
;THE ANSWER IS RETURNED IN ACCUMULATOR A.
	...
	SEARCH	FORPRM
	HELLO	(SQRT,.)		;ENTRY TO SQUARE ROOT ROUTINE
...
F:	BLOCK	1		;STORE FRACTION HERE
	...
	PRGEND
TITLE	SINH	%2.(120) ;FROM LIB40 VERSION V.027
SUBTTL	D. TODD /DRT 15-FEB-1973	KAREN KOLLING/DMN
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS. ***
...
;THE ANSWER IS RETURNED IN AC 0.
	...
	HELLO	(SINH,.)		;ENTRY TO HYPERBOLIC SINE ROUTINE.
...
ONESIX:	0.16666667
	PRGEND
TITLE	COSH	%2.(120) ;FROM LIB40 VERSION V.032(400)
SUBTTL	D. TODD /DRT 15-FEB-1973	ED YOURDAN/KK/DMN
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS. ***
...
LN2BE:	200542710300	;LOG(2) BASE E.
	...
	PRGEND
TITLE	TANH  %2.(120) ;FROM LIB40 VERSION V.021
SUBTTL	D. TODD /DRT 15-FEB-1973	ED YOURDON/KK
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS. ***
...
SAVEA:	0
	PRGEND
TITLE EXP1	%2.(120)	;FROM LIB40 VERSION 	32(341)
...
TITLE	EXP3	%2.(120) ;FROM LIB40 VERSION V.32(377)
SUBTTL	D. TODD /DRT 15-FEB-1973	/DMN
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS. ***
...
EXTERNAL	EXP2.0
	SEARCH	FORPRM
IFN F40LIB,<ENTRY	EXP3.2,EXP3.4,EXP3.6>
...
EXP3A:	POPJ	P,		;EXIT
	...
	LIT
	PRGEND
TITLE EXP2	%2.(120) ;FROM LIB40 VERSION V32(415)
SUBTTL	D. TODD /DRT 15-FEB-1973	22-MAY-72	/DMN
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS. ***
...
;CALLED. THE ANSWER IS RETURNED IN ACCUMULATOR N.
	...
	SEARCH	FORPRM
IFN F40LIB,<ENTRY	EXP2.2,EXP2.4,EXP2.6>
...
SAVEC:	0			;TEMP FOR C.
	...
	LIT
	PRGEND
TITLE	EXP  %2.(120) ;FROM LIB40 VERSION V.027
SUBTTL	D. TODD /DRT 15-FEB-1973	ED YOURDON/KK/DMN
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS. ***
;FROM	V.021	8-AUG-69
...
ES3:	0
	...
	LIT
	PRGEND
TITLE	ALOG  %2.(120) ;FROM LIB40 VERSION V.32(342)
...
LZ:	0
	...
	PRGEND
TITLE	SIN	%2.(120) ;FROM LIB40 VERSION V.32(340)
SUBTTL	D. TODD /DRT 15-FEB-1973	ED YOURDAN/KK/DMN
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS. ***
...
Q=16
	...
	HELLO	(COSD,.)			;ENTRY TO COSINE DEGREES ROUTINE.
	...
	HELLO	(SIND,.)			;ENTRY TO SINE DEGREES ROUTINE.
	MOVE	B,@(Q)		;PICK UP THE ARG.
	FDVR	B,SCD1		;CONVERT TO RADIANS
	JFCL			;SUPPRESS ERROR MESSAGE ON UNDERFLOW.
	JRST	S1		;ENTER SINE ROUTINE.

	HELLO	(COS,.)			;ENTRY TO COSINE RADIANS ROUTINE.
	MOVE	B,@(Q)		;PICK UP THE ARG.
	FADR	B,PIOT		;ADD PI/2.
	JRST	S1		;ENTER SINE ROUTINE.


	HELLO	(SIN,.)		;ENTRY TO SINE RADIANS ROUTINE.
	MOVE	B,@(Q)		;PICK UP THE ARG.
