...
FILE-CONTROL.                                                     
     SELECT I1 ASSIGN DSK,                                        
      RECORDING MODE IS ASCII.                                    
                                                                  
     SELECT I2 ASSIGN DSK,                                        
      RECORDING MODE IS ASCII.                                    
...
77   CN1   PICTURE S9(4) COMPUTATIONAL VALUE 0 SYNC.              
77   CN2   PICTURE S9(4) COMPUTATIONAL VALUE 0 SYNC.              
77   CN3   PICTURE S9(4) COMPUTATIONAL VALUE 0 SYNC.              
77   CN4   PICTURE S9(4) COMPUTATIONAL VALUE 0 SYNC.              
77   CN5   PICTURE S9(4) COMPUTATIONAL VALUE 0 SYNC.              
77   CN6   PICTURE S9(4) COMPUTATIONAL VALUE 0 SYNC.              
77   CN7   PICTURE S9(4) COMPUTATIONAL VALUE 0 SYNC.              
77   X1    PICTURE S9(4) COMPUTATIONAL VALUE 0 SYNC.              
...
READ-I2.                                                          
     READ I2 AT END MOVE 0 TO CN1 CN2 CN3 PERFORM CL-TXLE         
        THRU E-CL-TXLE                                            
     GO TO READ-I1.                                               
...
LOAD-CN1.                                                         
     ...
     GO TO READ-I2.                                               
READ-I1.                                                          
     READ I1 AT END PERFORM PR-PRINT THRU E-PR-PRINT  GO TO       
                                                           EOP--X.
