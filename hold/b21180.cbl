...
FILE-CONTROL.
        ...
        RECORDING MODE IS ASCII.
I-O-CONTROL.
        RERUN EVERY 50 RECORDS OF EMPLOYEE-FILE.
DATA DIVISION.
FILE SECTION.
FD  EMPLOYEE-FILE
        LABEL RECORDS ARE STANDARD
        VALUE OF IDENTIFICATION IS "B21180EMP".
01      EMPREC.
        05 NAME   PIC X(15).
        05 EMPNUM PIC X(5).
        05 HOURS  PIC 99V9.
...
FD RATE-FILE
        LABEL RECORDS ARE STANDARD
        VALUE OF IDENTIFICATION IS "B21180RAT".
01      RATE-REC PIC X(7).
FD SALARY-REPORT
        LABEL RECORDS ARE STANDARD
        VALUE OF IDENTIFICATION IS "B21180RPT".
...
MAIN-PGM.
        ...
        MOVE ZERO TO IDX.
        PERFORM SEARCH-RATES THRU SEARCH-EXIT.
...
SEARCH-RATES.
        ADD 1 TO IDX.
        IF IDX GREATER 18, MOVE ZERO TO COMPUTED-AMT,
                           GO TO SEARCH-EXIT.
        IF S-CODE IN EMPREC NOT = S-CODE IN RT-TBL (IDX),
           GO TO SEARCH-RATES.
        IF S-CD-1 IN RT-TBL (IDX) = 'H',
          COMPUTE COMPUTED-AMT ROUNDED = HOURS IN EMPREC * RATE (IDX)
         ELSE MOVE RATE (IDX) TO COMPUTED-AMT.
SEARCH-EXIT.
        EXIT.
WRITE-TRLRS.
        ...
        CLOSE SALARY-REPORT.
        DISPLAY '*** END OF JOB, TYPE SALPG1.RPT FOR SALARY REPORT.'.
        STOP RUN.
BUILD-RATE-TABLE.
        SET IDX UP BY 1.
