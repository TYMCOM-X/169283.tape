...
105 PRINT " PLEASE TYPE  1  TO GET THE 72 CHARACTER OUTPUT  OR 2 FOR WIDE CARRIAGE"
110 INPUT W3
...
2260 H(2,Y)=H2
2265 NEXT Y
2270 IF O0=1 THEN 2285
2274 C=B3-1
2275 FOR X=1 TO 13-Q3
2276 C=C+1
2277 M(C,2)=(H(2,1)/2)/(13-Q3)
2278 S4=S4+M(C,2)
2279 NEXT X
2281 O0=1
2282 H=0
2283 X1=X1-(H(2,1)/2)
2284 ON X9 GOTO 1830,1940,2040,2080,2160,2270
2285 FOR X=1 TO E+1
2286 H(2,X)=H(2,X)/W1
2287 FOR Y1=1 TO W1
2290 C=C+1
...
2312 FOR X0=1 TO Q3
2314 C=C+1
2315 IF Q3=1 THEN 2318
2316 M(C,2)=H(2,E+2)/(Q3-1)
2317 GO TO 2319
2318 M(C,2)=H(2,E+2)
2319 S4=S4+M(C,2)
2320 NEXT X0
