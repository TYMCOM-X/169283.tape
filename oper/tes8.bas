...
2289 F6=Z(B3)
2290 C1=B3-1+W1/2
2291 F7=W1*(Y3-1)+W1-P+2
2292 IF F7<B3 THEN 2295
2293 GO TO 2310
2295 F7=F7+W1
2310 FOR Y=F7 TO W1+W1*X2
2312 C1=C1+1
2314 M(Y,2)=Z(C1)
2316 NEXT Y
2320 FOR Y=B3 TO F7-1
2321 M(Y,2)=(F6*W1/2)/(F7-B3)
2322 NEXT Y
2324 MAT H=ZER
2326 NEXT I9
2328 GO TO 235
...
3665 PRINT
3670 PRINT
3675 PRINT USING 3620, "SALE"0,0,0,0,K1,K1-X0,-K2,K3,T5
3680 PRINT
...
4804 F6=Z(B3)
4806 C1=B3-1+W1/2
4808 F7=W1*(Y3-1)+W1-P+2
4810 IF F7<B3 THEN 4816
4812 GO TO 4822
4816 F7=F7+W1
4822 FOR Y=F7 TO W1+W1*X2
4824 C1=C1+1
4826 M(Y,2)=Z(C1)
4828 NEXT Y
4830 FOR Y=B3 TO F7-1
4832 M(Y,2)=(F6*W1/2)/(F7-B3)
4833 NEXT Y
4834 MAT H=ZER
4836 NEXT I9
4838 GO TO 2745
