	SUBTTL	EXEC V24/01	07-FEB-72	DEBUG+STR'S	/DLH
...
	TLNN	%16,LSTFLG
	...
	PUSHJ	%17,ERRSP	;**V24/01** INST
	MOVE	%00,PROGNZ	;**V24/01** INST
	PUSHJ	%17,LSTSIX	;**V24/01** INST
IFN CCLSW,
<	SKIPE	CCLFLA		;IN CCL MODE, DON'T TYPE "0 ERRORS"
	JUMPE	%11,[PUSHJ %17,ERRCR	;**V24/01** INST
		JRST	REST4]	;**V24/01** INST
>
...
SWTABA:
	SETSW	X,<AOSA  DEBUGF>		;**V24/01** DEBUG
...
CHAR4:	TRZE	%16,EOFBIT	;EOF IN PROGRESS?
	PUSHJ	%17,CHAR5	;**V24/01** STR #4684
