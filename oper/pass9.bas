...
1120 I7=B3
1140 GOTO 1460
1160 PRINT"DATA INPUT FOR INTEREST: INTEREST,STARTING YR,QTR;ENDING YR,QTRFOR EACH AMT (ALL ZEROES TO END)"
1180 INPUT I6,Y2,Q2,Y3,Q3
...
4360 PRINT USING 4160, (Q1/4)+1,K1,X0,0,0,0,K1,K1-X0,-K2,K3,T5
4380 PRINT
...
9080 PRINT "QTLY CF EARNGS RATE";
9100 INPUT E9
