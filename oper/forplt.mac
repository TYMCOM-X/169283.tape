...
50	RETURN
	END	END	SUBROUTINE LINE(X,Y,N,K)
	DIMENSION X(1),Y(1)
	I3=3
	NP=N*K
	DO 10 I=1,NP,K
...
.S0000:	BLOCK	1
	PRGEND
TITLE SCALE - A PLOTTER SUBPROGRAM %2.(100)
...
D:	0
	...
	LIT
	PRGEND
	TITLE	PLOTF (FEANORIAN CHARACTER SET) %2,(100)
...
PRGEND
	TITLE	PLOTC (RUSSIAN CHARACTER SET) %2.(100)
	SUBTTL	BILL WEIHER: STANFORD A-I; 21 OCT 67
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS.***
ENTRY PLOTC
RADIX 10
...
T2105:	BYTE (5) 1,0,7,1,1,8,1,1,10,1,4,10,1,4,6,1,4,7,1,0,7
	BYTE (5) 0,8,6
T2106:	BYTE (5) 0,0,8,1,4,89,1,3,10,1,1,10,1,0,9,1,0,7
...
PLOTC:	XWD 0,0
	...
	REPEAT 36,<XWD 0,0>
PRGEND
TITLE PLOT SUBROUTINES -%2.(100);FROM	 V010 - 05 AUG 68
...
STPSIZ:	DEC 100.0	;STEPS PER INCH
	...
	PRGEND
TITLE PLOTCD (DUMMY PLOTC) %2.(100)
	SUBTTL	D. TODD /DRT/     08-DEC-1972
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS.***
	SEARCH FORPRM
ENTRY PLOTC
PLOTC:	ERROR	(MSG,0,17,[ASCIZ /PLOTC NOT LOADED/])
	FUNCT	EXIT
PRGEND
TITLE PLOTFD (DUMMY PLOTF) %2.(100)
	SUBTTL	D. TODD /DRT/     08-DEC-1972
;***COPYRIGHT 1972,1973 DIGITAL EQUIPMENT CORP., MAYNARD, MASS.***
	SEARCH FORPRM
ENTRY PLOTF
PLOTF:	ERROR	(MSG,0,17,[ASCIZ /PLOTF NOT LOADED/])
	FUNCT EXIT
END
 "jv‡