...
01	TO-HOLD-A-WORD		PICTURE X(70).
	...
	88 W-OMITTED		VALUE "OMITTED".
        88 W-EXCEEDS    VALUE "EXCEEDS".
        88 W-MINUS              VALUE "MINUS".
        88 W-PLUS               VALUE "PLUS".
        88 W-BY                 VALUE "BY".
        88 W-MULTIPLIED         VALUE "MULTIPLIED".
        88 W-EXPONENTIATED      VALUE "EXPONENTIATED".
        88 W-DIVIDED            VALUE "DIVIDED".
        88 W-TIMES      VALUE "TIMES".
        88 W-THEN               VALUE "THEN".
        88 W-OTHERWISE          VALUE "OTHERWISE".
	88 W-INCLUDE		VALUE "INCLUDE".
	88 W-COMPUTATIONAL-3	VALUE "COMPUTATIONAL-3", "COMP-3",
	...
	88 FLAG-CLAUSE		VALUE "TODAYS-DATE", "BLOCK", "CONTAINS",
                                      ...
                                      "ACTIVE-TIME","SEQUENCED",
                        "CLASS","SIZE","SIGNED","POINT".
	88 W-DELETE-CLAUSE	VALUE "RECORDING".
	88 W-ZERO		VALUE "0", "ZERO".
	88 W-NOTE		VALUE "NOTE".
	88 W-ADVANCING		VALUE "ADVANCING".
        88 ENV-WORDS-FLAGGED-3  VALUE                            
                                "CONTROL-MODULE","ON","CHECK-POINT",
                                "SYNCHRONOUS",       "BLOCK",
                                "PRIMING-CODE","USING",         "AM",
                                "RENAMING",                         
                                     "APPLY","FIXED","COUNT","SYMBOL",
                                     "COMPATIBLE","PRINT".
        88 ENV-WORDS-FLAGGED-2  VALUE "RERUN","REEL","MULTIPLE",
                                        "SAME","RECORD",
                                        "POSITION","OPTIONAL",
                                        "I-O-CONTROL".
	88 PD-WORDS-FLAGGED	VALUE "ENTER", "TRANSFORM", "CALL",
                        ...
                        "COPY","POSITIONING".
	88 W-TODAYS-DATE	VALUE "TODAYS-DATE".
	88 W-CHARACTERS		VALUE "CHARACTERS".
	88 W-F-U-V		VALUE "F", "U", "V".
	88 W-CONSOLE		VALUE "CONSOLE","CONSOLE-TYPEWRITER".
	...
	88 W-FD			VALUE "FD".
        88 W-TO                 VALUE "TO".
        88 W-FD-KEY-WORD        VALUE "BLOCK","RECORD","DATA","REPORT",
                                      "LABEL","REPORTS","SEQUENCED",
                                      "ACTIVE-TIME","FILE".
        88 W-IS                 VALUE "IS".
...
START.    DISPLAY "RCA TO DEC  COBOL PROGRAM CONVERSION AID".
...
RESTART-1. DISPLAY "RCA-FORMAT FILE NAME: " WITH NO ADVANCING.
...
PROCESS-ENV-1.
	IF W-SOURCE-COMPUTER GOROCESS-SOURCE-COMPUTER.
...
PROCESS-ENV-2.
        IF ENV-WORDS-FLAGGED-2  MOVE "*2*" TO LISTING-FLAG.
...
PROCESS-DD-0.
	...
	IF W-COMPUTATIONAL-3 GO TO PROCESS-COMP-3.
...
*	COMPUTATIONAL-3.  CHANGE TO COMPUTATIONAL AND FLAG.
...
PROCESS-FD.
	...
	PERFORM PUT-WORD.
        MOVE "*2*" TO LISTING-FLAG.
	PERFORM WRITE-LINE.
        MOVE SPACES TO IDENT-CLAUSE-ID, IDENT-DONE.
PROCESS-FD-1.
        PERFORM GET-WORD; IF END-OF-SOURCE GO TO PROCESS-DD-9.

PROCESS-FD-2.
        IF FIRST-COLUMN LESS THAN 12
          GO TO PROCESS-FD-9.
...
PROCESS-IDENT-CLAUSE.
        ...
        MOVE "X" TO SKIP-FLAG.
        PERFORM GET-WORD.
        IF W-IS PERFORM GET-WORD.
        MOVE SPACE TO SKIP-FLAG.
        IF W-FD-KEY-WORD  OR  FIRST-COLUMN LESS THAN 12
...
PROCESS-FD-9.
        ...
        MOVE PERIOD-LINE TO SHORTEST-LINE.
        PERFORM WRITE-LINE.
        GO TO PROCESS-DD-1.
...
PROCESS-PD-0.
	...
	IF W-CONSOLE GO TO PROCESS-CONSOLE.
        IF W-EXCEEDS  MOVE "GREATER" TO THIS-WORD,
                        MOVE "*1*" TO LISTING-FLAG.
        IF W-THEN       MOVE "*1*" TO LISTING-FLAG,
                        GO TO PROCESS-PD-2.
        IF W-OTHERWISE  MOVE "ELSE" TO THIS-WORD,
                        MOVE "*1*" TO LISTING-FLAG,
                        GO TO PROCESS-PD-2.
        IF W-MINUS      MOVE "-" TO THIS-WORD,
                        MOVE "*1*" TO LISTING-FLAG,
                        GO TO PROCESS-PD-2.
        IF W-PLUS       MOVE "+" TO THIS-WORD,
                        MOVE "*1*" TO LISTING-FLAG,
                        GO TO PROCESS-PD-2.
        IF W-TIMES      MOVE "*" TO THIS-WORD,
                        MOVE "*1*" TO LISTING-FLAG,
                        GO TO PROCESS-PD-2.
        IF W-MULTIPLIED MOVE "*" TO THIS-WORD,
                        GO TO PROCESS-BY.
        IF W-EXPONENTIATED MOVE "**" TO THIS-WORD,
                        GO TO PROCESS-BY.
        IF W-DIVIDED    MOVE "/" TO THIS-WORD,
                        GO TO PROCESS-BY.
        IF FLAG-COLLATE
