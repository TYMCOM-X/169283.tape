...
260   FOR J=1 TO 8
270   R=RND*1320
280   IF R>=1.00000E-04 THEN 282
281 K3=K3+1
282 IF R>=1.00000E-02 THEN 284
283 K3=K3+1
284 IF R>=3.00000E-02 THEN 286
285 K3=K3+1
286 IF R>=8.00000E-02 THEN 288
287 K3=K3+1
288 IF R>=.28 THEN 290
289 K3=K3+1
290 IF R>=1.28 THEN 292
291 K3=K3+1
292 IF R>=3.28 THEN 294
293 K3=K3+1
294 IF R>=6.28 THEN 296
295 K3=K3+1
296 IF R>=13.28 THEN 300
297 K3=K3+1
300   K9=K9+K3
301 IF K9=0 THEN 309
304 IF K9<51 THEN 310
305 IF K9<200 THEN 309
306 K9=K9/10
309 K9=50
310   IF RND>.96 THEN 315
311 B3=0
312 GO TO 320
315 B3=1
320   B9=B9+B3
...
775   W3=S2+1 
776   IF W<1 THEN  984
777   IF W1>8 THEN  986
778   IF W2<1 THEN  986
779   IF W3>8 THEN  986
780   FOR I=W TO W1 
790   FOR J=W2 TO W3
...
980 REM
981 REM: SHORT R. SENSOR SCAN (PT II)
982 REM
984 W=1
985 GO TO 780
986 W=8
...
1050   NEXT J 
1060   PRINT "   "; 
1070   ON I GO TO 1120,1140,1160,1180,1200,1220,1240 ,1080
1080   PRINT  
1090   NEXT I 
1100   PRINT "----------------------" 
1110   GOTO 1260
...
1273   GOTO 1280
1275   Y5=1 
1280   ON A+1 GO TO 1380,770,2070,2270,2510,3010,1290,1290,1290,1290,1290,1290
...
1420   IF C1<1 THEN 1390 
1422 IF C1 >=9 THEN 1390
1440   PRINT "WARP FACTOR"; 
1450   INPUT W1 
1460   IF W1<0 THEN 1390 
1462 IF W1>12 THEN 1390
...
1550   FOR I=1 TO 6 
1560   D(I)=D(I)+1
1561   IF D(I)>0 THEN  1563
1562 GO TO 1570
1563 D(I)=0
1570   NEXT I 
1580   IF RND>.25 THEN 1800
1590   R1=INT(RND*6+1) 
1600   IF RND>.5 THEN 1670 
1610   D(R1)=D(R1)-(RND*5+1) 
...
1730   GOTO 1790
1740   R1=I 
1750   D(I)=D(I)+RND*5+1 
1751   IF D(I)>0 THEN  1753
1752 GO TO 1760
1753 D(I)=0
1760   PRINT "*** TRUCE, "; 
1770   S=(R1-1)*12+1
...
1890   S1=S1+X1 
1900   S2=S2+X2 
1910   IF S1<.5 THEN 2020
1911 IF S2<.5 THEN 2020
1912 IF S1 >= 8.5 THEN 2020
1913 IF S2 >= 8.5 THEN 2020
...
2021   IF Q1>8 THEN  2023
2022 GO TO 2025
2023 Q1=8
2025   IF Q1<1 THEN  2027
2026 GO TO 2030
2027 Q1=1
2030   Q2=INT(Q2+W1*X2+(Y-.5)/8)
2031   IF Q2>8 THEN  2033
2032 GO TO 2035
2033 Q1=8
2035   IF Q2<1 THEN  2037
2036 GO TO 2040
2037 Q2=1
...
2172 IF I>8 THEN 2220
2174 IF J<1 THEN 2220
2176 IF J>8 THEN 2220
2210   N(J-Q2+2)=G(I,J) 
2220   NEXT J 
...
2620   IF C1<1 THEN 2580 
2621 IF C1>=9 THEN 2580
2630   GOSUB 2980 
2640   X=S1 
2650   Y=S2 
2660   P=P-1
...
2680   X=X+X1 
2690   Y=Y+X2 
2700   IF X<.5 THEN 2940
2701 IF Y<.5 THEN 2940
2702 IF X >=8.5 THEN 2940
2703 IF Y >=8.5 THEN 2940
...
2790   FOR I=1 TO 9 
2800   IF INT(X+.5)=K(I,1) THEN 2805
2801 GO TO 2810
2805 IF INT(Y+.5)=K(I,2) THEN 2820
2810   NEXT I 
2820   K(I,3)=0 
2830   GOTO 2910
...
3720   REM  
3730   GOTO 440 
5000   IF S=1 THEN 5002
5001 GO TO 5010
5002  PRINT "WARP ENGINES"; 
5010   IF S=13 THEN 5012
5011 GO TO 5020
5012  PRINT "SHORT RANGE SENSORS"; 
5020   IF S=25 THEN 5022
5021 GO TO 5030
5022  PRINT "LONG RANGE SENSORS";
5030   IF S=37 THEN 5032
5031 GO TO 5040
5032  PRINT "PHASOR CONTROL";
5040   IF S=49 THEN 5042
5041 GO TO 5050
5042  PRINT "PHOTON TUBE"; 
5050   IF S=61 THEN 5052
5051 GO TO 5070
5052  PRINT "DAMAGE CONTROL";
5070   RETURN 
6000   IF Q(I,J)=0 THEN 6002
6001 GO TO 6010
6002  PRINT ". ";
6010   IF Q(I,J)=1 THEN 6012
6011 GO TO 6020
6012  PRINT "E ";
6020   IF Q(I,J)=2 THEN 6022
6021 GO TO 6030
6022  PRINT "K ";
6030   IF Q(I,J)=3 THEN 6032
6031 GO TO 6040
6032  PRINT "B ";
6040   IF Q(I,J)=4 THEN 6042
6041 GO TO 6050
6042  PRINT "* ";
6050   RETURN 
7000   IF C=0 THEN 7002
7001 GO TO 7010
7002  PRINT "DOCKED"
7010   IF C=1 THEN 7012
7011 GO TO 7020
7012  PRINT "GREEN" 
7020   IF C=2 THEN 7022
7021 GO TO 7030
7022  PRINT "RED" 
7030   IF C=3 THEN 7032
7031 GO TO 7040
7032  PRINT "YELLOW"
7040   RETURN 
8000   IF Z=1 THEN 8002
8001 GO TO 8010
8002  PRINT "WARP ENGINES", 
8010   IF Z=13 THEN 8012
8011 GO TO 8020
8012  PRINT "S.R. SENSORS",
8020   IF Z=25 THEN 8022
8021 GO TO 8030
8022  PRINT "L.R.SENSORS", 
8030   IF Z=37 THEN 8032
8031 GO TO 8040
8032  PRINT "PHASOR CONTROL",
8040   IF Z=49 THEN 8042
8041 GO TO 8050
8042  PRINT "PHOTON TUBE", 
8050   IF Z=61 THEN 8052
8051 GO TO 8060
8052  PRINT "DAMAGE CONTROL",
8060   RETURN 
9000 END
  