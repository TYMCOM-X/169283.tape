...
77   O           COMPUTATIONAL   PICTURE 9(5).
01   MATRIX.
     02  MAT1        OCCURS 6.
         03  MAT2    OCCURS 3000.
             04  MATF            PICTURE 9.
...
ZERO-MAT.                                                         
     ...
     ADD 1 TO B.                                                  
     IF B IS NOT EQUAL TO  3001  GO TO ZERO-MAT.                  
...
FIX-SUB.                                                          
     MOVE H TO O.
     IF H IS LESS THAN 3001 MOVE 1 TO F1.
     IF H IS GREATER THAN 3000 MOVE 2 TO F1 SUBTRACT 3000 FROM H.
     IF H IS GREATER THAN 3000 MOVE 3 TO F1 SUBTRACT 3000 FROM H.
     IF H IS GREATER THAN 3000 MOVE 4 TO F1 SUBTRACT 3000 FROM H.
     IF H IS GREATER THAN 3000 MOVE 5 TO F1 SUBTRACT 3000 FROM H.
     IF H IS GREATER THAN 3000 MOVE 6 TO F1 SUBTRACT 3000 FROM H.
     MOVE H TO F2 MOVE O TO H.
MOVE-SUB.                                                         
...
FIND-HEAD.                                                        
     MOVE J TO H PERFORM FIX-SUB.                                 
     IF F2 = 3001 DISPLAY 'COULD NOT FIND HEAD-OF-STRING'         
