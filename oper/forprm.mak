	UNIVERSAL FORPRM %2.(153) - FOROTS UNIVERSAL PARAMETER FILE
	SUBTTL	D. TODD /DRT/     01-APR-1973
...
VFOROT==1		;FOROTS SYSTEM VERSION NUMBER
VERNO==1		;MAJOR VERSION NUMBER
...
; EXTERNAL SYSTEM SYMBOLS
	EXTERN	.JBFF,.JBREL,.JBSA,.JBTPC,.JBOPC,.JB41,.JBHRL
.JBOPS==135
...
IFNDEF %V1,<%V1==-1>		;ASSEMBLE VERSION CALLING SEQUENCE
				;DOES NOT CONFLICT WITH VERSION2
...
;	FORTRAN LIBRARY ASSEMBLY PARAMETERS
	...
	IFNDEF F40LIB,<F40LIB==-0 ;ASSEMBLE THE LIBRARY FOR F40
...
FT.ELT==001000	;ELIST IN PROCESS
...
	SUBTTL FORERR MACROS FOR DEFINING ENTRIES TO THE ERROR ROUTINE
	...
	IFL 17-TYPE,<PRINTX THE ERROR TYPE. TYPE FOR ER%'CLASS TOO BIG>
