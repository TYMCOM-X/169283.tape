...
CRSHCT 0                       CRASH COUNT
       IF      8
N940L  +NLINES+200             NUMBER OF 940S AND 201 LINES
       ELSE
N940L  +NLINES+100             NUMBER OF 940S AND 201 LINES
       ENDIF
$
UPDOWN -1
$
...
* DOWNSTREAM RECORD
       ...
       ASLA    1
       IF      8
       ADD     =BUFERS+NLINES+NLINES+400
       ELSE
       ADD     =BUFERS+NLINES+NLINES+300
       ENDIF
       TAX
       JMPM    LEPSN
       JMP     LEP
