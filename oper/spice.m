...
C
        ...
        CALL ERRSET(0)
        TYPE 900
900     FORMAT(1X,'000000 000008'/1X,'VERSION 1L'/)
        WRITE(5,1000)
1000    FORMAT(1X,'INPUT FROM: '$)
        READ(5,1001)FNAME
1001    FORMAT(2A5)
        IDT=IDTER(FNAME)
        IF(IDT.EQ.1)GO TO 10
        IDI=21
        OPEN(21,FNAME,INPUT,SYMBOLIC,ERR=2000)
        GO TO 20
10      IDI=5
20      WRITE(5,1002)
1002    FORMAT(1H+,'OUTPUT TO: '$)
        READ(5,1001)FNAME
        IDT=IDTER(FNAME)
        IF(IDT.EQ.1)GO TO 30
        IDO=22
        OPEN(22,FNAME,OUTPUT,SYMBOLIC,ERR=2010)
        CALL SIMTTY(22)
        GO TO 40
30      IDO=5
C
...
200     CALL VALPRI(4,202,'APPUS')
        WRITE(5,1020)
1020    FORMAT(//1X)
C
        GO TO 9999
2000    TYPE 2001
2001    FORMAT(1H+,'FILE NOT AVAILABLE')
        GO TO 200
2010    TYPE 2011
2011    FORMAT(1H+,'BAD FILE NAME')
        GO TO 20
9999    CONTINUE
        END
