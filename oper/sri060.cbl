...
FD   ACCIDENT-FILE
         VALUE OF IDENTIFICATION IS "ACCIDTIDX"
         LABEL RECORDS ARE STANDARD
         RECORD CONTAINS 176 CHARACTERS
     BLOCK CONTAINS 41 RECORDS
         DATA RECORD IS ACC-IN-REC-1.
01   ACC-IN-REC-1 DISPLAY-7.
     02  FIELD-1 USAGE DISPLAY-7.
         03  DELETE-CODE             PICTURE X.
         03  RECORD-KEY.
             04  IS-CODE-A           PICTURE X(10) USAGE DISPLAY-7.
             04  IND-NO-A            PICTURE 999 USAGE DISPLAY-7.
             04  REC-CODE-A          PICTURE 9  USAGE DISPLAY-7.
     ...
     02  FIELD-2                 PICTURE 9(17).
     02  FIELD-3                 PICTURE 9(17).
     02  FIELD-4                 PICTURE 9(17).
     02  FIELD-5                 PICTURE 9(17).
     02  FIELD-6                 PICTURE 9(17).
     02  FIELD-7                 PICTURE 9(17).
     02  FIELD-8                 PICTURE 9(17).
     02  FIELD-9                 PICTURE 9(17).
WORKING-STORAGE  SECTION.
77   FILLER-2        PICTURE X(21) VALUE 'BEGIN WORKING STORAGE'.
77   DUMMY-SW         PIC X(1)  VALUE '0'.
...
01   REPORT-DATE.
     ...
     03 TO-DATE.
        ...
        05 TO-MO             PICTURE 99.
        05 TO-DA             PICTURE 99.
01   A-SYM-KEY   USAGE IS DISPLAY-7.
     03 A-SYM-KEY-IS.
        05 A-SYM-ST-1        PICTURE X(5) USAGE DISPLAY-7.
        05 A-SYM-ST-2        PICTURE X(5) USAGE DISPLAY-7.
     03 A-SYM-INDEX          PICTURE 999 USAGE DISPLAY-7.
     03 A-SYM-REC-CODE       PICTURE 9 USAGE DISPLAY-7.
