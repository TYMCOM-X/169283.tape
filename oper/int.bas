...
281 B6=A6*B7
282 IF STR(Z$,1,4)<>"READ" THEN 290
283 PRINT "READ FROM:";
284 INPUT D$
...
364 INPUT K$
365 IF STR(K$,3,3)="IDC" THEN 368
366 IF STR(K$,4,3)="IDC" THEN 370
367 GO TO 382
368 K$="NO"
369 GO TO 371
370 K$="YES"
...
373 INPUT N4
374 N3=N4*A6
382 IF STR(Z$,1,4)="USED" THEN 388
384 M9=200
386 GO TO 410
388 M9=150
...
2705 GO TO 2726
2710 L=L8*(B6+N3)
2726 IF STR(Z$,1,4)<>"READ" THEN 2749
2727 OPEN 3,D$,INPUT
...
3650 NEXT Y
3675 NEXT X
3680 IF STR(Z$,4,1)="R" THEN 3724
3681 IF STR(Z$,5,1)="R" THEN 3724
3682 GO TO 3800
3685 FOR X=1 TO Y1
...
3710 NEXT Y
3720 NEXT X
3721 IF STR(Z$,4,1)="R" THEN 3724
3722 IF STR(Z$,5,1)="R" THEN 3724
3723 GO TO 3800
...
3730 M(X,2)=D(X,2)
3731 NEXT X
3800 OPEN 2,"ATCF",OUTPUT
3801 OPEN 1,"TERMX2",OUTPUT
3825 PUT 2:Q+1,(E-X5)*(-1)
...
7502 PRINT"     ------------------------------------------------------   -----------------------------------------   --------------- --------------------"
7504 PRINT
7505 PRINT"     NET                                                       NET     INTEREST                             NET     TAX LOSS ACTUAL"
7506 PRINT"     RENTAL     DEPRE-      INTEREST  ON             TAXABLE    RENTAL     ON     BOND    OTHER TAXABLE    TAXABLE   CARRY-   TAXES"
7507 PRINT" PD  INCOME     CIATION  DEBT  & BALLOON  FEES      INCOME     INCOME  CON.DEBT  DISC.   EXP    INCOME    INCOME   FORWARD   PAID"
7509 PRINT" --  --------  --------  -------  ------  ------  ---------   --------  ------  ------  ------ --------  --------- -------- -------"
7525 I=0
7526 B1=0
7530 FOR J=1 TO 14
...
7580 T(14)=T(14)+B(I,14)
 7590 B1=B1+1
7595: ##  ########  ########  #######  ######  ######  #########   ########  ######  ######  ###### ########  ######### ######## ########
7600 PRINT USING 7595,B1,T(1),T(2),T(3),T(4),T(5),T(6),T(7),T(8),T(9),T(10),T(11),T(12),T(13),T(14)
...
7635 NEXT I
7640 NEXT J
7645 PRINT USING 7650,T(1),T(2),T(3),T(4),T(5),T(6),T(7),T(8),T(9),T(10),T(11),T(12),T(14)
7650:     ########  ########  #######  ######  ######  #########   ########  ######  ######  ###### ########  #########          ########
7651 FOR I=1 TO Q
7652 K(I)=0
7653 NEXT I
...
7774 PRINT "     --------------------------------   -------------------------------------  ------------------------------------------------------"
7776 PRINT"      NET      DEBT SERVICE    PRE      NET      INTEREST   OTHER    PRE         PRE                 AFTER       CUM."
7777 PRINT"      RENTAL   ON AMORTIZED    TAX      RENTAL      ON      CASH     TAX         TAX       TAXES     TAX     AFTER TAX     NET"
7780 PRINT" PD   INCOME  DEBT & BALLOON   CASH     INCOME   CONV.DEBT  EXP      CASH        CASH      PAID      CASH        CASH   INVESTMENT"
7783 PRINT" --  -------- ------- ------  -------  --------  --------  ------  --------   ---------  -------  ---------  ---------- --------"
7784 PRINT
7800 I=0
7801 B1=0
...
7860 T(13)=B(I,13)
7865 B1=B1+1
7870 PRINT USING 7875,B1,T(1),T(2),T(3),T(4),T(5),T(6),T(7),T(8),T(9),T(10),T(11),T(12),T(13)
7875: ##  ######## ####### ######  #######  ########  ########  ######  ########   #########  #######  #########  ########## ##########
...
7910 NEXT J
7911:     ######## ####### ######  #######  ########  ########  ######  ########   #########  #######  #########  ########## ##########
7915 PRINT USING 7911,T(1),T(2),T(3),T(4),T(5),T(6),T(7),T(8),T(9),T(10),T(11),T(12),T(13)
7916 FOR I=1 TO 4
7917 PRINT
7918 NEXT I
